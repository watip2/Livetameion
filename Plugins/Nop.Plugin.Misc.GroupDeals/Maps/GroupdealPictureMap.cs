...
{
    public class GroupdealPictureMap : EntityTypeConfiguration<GroupdealPicture>
    {
        public GroupdealPictureMap()
        {
            ...
            ToTable("GroupdealPictures");
            HasKey(gd => gd.Id);

            Property(gd => gd.GroupdealId);
            Property(gd => gd.PictureId);
