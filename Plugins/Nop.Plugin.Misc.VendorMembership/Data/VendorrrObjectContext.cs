...
{
    public class VendorrrObjectContext : DbContext, IDbContext
    {
        public VendorrrObjectContext(string nameOrConnectionString) : base(nameOrConnectionString) { }
        ...
        public void Install()
        {
            ...
            Database.SetInitializer<VendorrrObjectContext>(null);
        ...
        {
            var dbScript = "DROP TABLE Vendorrr";
